...
@Dao
internal abstract class ReleasesCountriesDao : BaseDao<ReleaseCountry> {
    ...
    abstract fun getReleasesFromCountry(areaId: String): PagingSource<Int, ReleaseRoomModel>
