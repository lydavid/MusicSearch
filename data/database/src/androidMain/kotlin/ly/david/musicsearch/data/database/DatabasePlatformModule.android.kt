...
private class DriverFactory(
    ...
    private val androidBuildConfig: AndroidBuildConfig,
) {
    fun createDriver(): SqlDriver {
        return AndroidSqliteDriver(
            ...
            factory = if (androidBuildConfig.isDebug && Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
