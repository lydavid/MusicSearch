...
abstract class RoomRecordingReleaseDao : BaseDao<RecordingRelease>() {
    ...
    companion object {
        private const val RELEASES_BY_RECORDING = """
            ...
            LEFT JOIN artist_credit_entity acr ON acr.entity_id = rel.id
    ...
    abstract fun getReleasesByRecording(recordingId: String): PagingSource<Int, RoomReleaseForListItem>
