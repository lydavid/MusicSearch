...
/**
 * Originally generated by scrape_relationships.py Selenium script using data from https://musicbrainz.org/relationships.
 *
 * The format is: "id" to ("forward description" to "backward description").
 *
 * The types of attributes are as follows:
 * 1. {additional}: these could be present or absent
 * 2. {vocal:%|vocals}: these could be present and non-specific ("vocals") or specific ("background vocals"), or absent
 *
 * Note that {vocal:%|vocals} and {instrument:%|instruments} are not attributes with attribute values. They are attributes themselves.
 *
 * Some attributes with values are:
 * - task: vocal direction
 * - number: 25
 */
...
internal val relationshipHeaders = hashMapOf(
    ...
    // {additional}
    "aa10bd8a-a460-49d7-9280-7d9beadde341" to ("artwork" to "artwork"),
    // {additional} {assistant}
    "294b9803-9b84-451b-9a1f-2448eeec8fe1" to ("design" to "design"),
    // {additional}
    "2b3b31ba-bb5e-4fbc-a095-9538a74b6b89" to ("graphic design" to "graphic design"),
    // {additional}
    "7feaa96b-60b3-4a88-9ecd-26a178c2fa70" to ("illustration" to "illustration"),

    // https://musicbrainz.org/relationships/genre-label
    "b80f8b51-2212-415a-9ed1-bb5636b96d02" to ("named after label" to "inspired the name of genre"),
    ...
    "1a502d1c-2c30-4efa-8cd7-39af664e3af8" to ("reissuing the catalog of" to "catalog reissued by"),
    ...
    "9e338897-2b63-40a8-b7c1-fca0dbbaa3cd" to ("artist-in-residence at" to "artists-in-residence"),
    // {assistant}
    "f8920cb5-ae7f-465c-8128-d124a3eff3b9" to ("carillonneur at" to "carillonneur"),
    ...
    "0dafbb5d-26eb-4a52-bb0c-af13ffe36544" to ("school director at" to "school directors"),
    ...
    "8a3994fd-71ec-4443-9882-2192801241f2" to ("inspired the name of place" to "named after artist"),
    "f58cff57-79e2-4c34-9312-6bd9f43c97c6" to ("inspired the name of artist" to "named after place"),
    ...
    "ee182e02-eef7-43ae-b99c-eee1ed60ebc2" to ("named after place" to "inspired the name of genre"),
    ...
    // performance
    // {additional:additionally} {guest} {solo}
    "628a9658-f54c-4142-b0c0-95f031b544da" to ("performed" to "performer"),
    ...
    // {additional}
    "3b6616c5-88ba-4341-b4ee-81ce1e6d7ebb" to ("orchestra" to "orchestra"),
    // {additional:additionally}
    "234670ce-5f22-4fd0-921b-ef1662695c5d" to ("conducted" to "conductor"),
    // {additional}
    "45115945-597e-4cb9-852f-4e6ba583fcc8" to ("chorus master" to "chorus master"),
    // {guest}
    "ffeaa74f-8295-45ee-a2f2-7c0cc1f73b1e" to ("concertmaster for" to "concertmaster"),
    // {assistant}
    "5de30d91-3b98-4fa6-9cd4-26d80959f540" to ("audio director for" to "audio director"),

    // {additional:additionally} {co:co-}
    "22661fb8-cdb7-4f67-8385-b2a8be6c9f0d" to ("arranged" to "arranger"),
    ...
    // {additional:additionally}
    "38fa7405-f9a5-48cb-827a-8ac601933ba0" to ("orchestrated" to "orchestrator"),
    ...
    // {additional:additionally}
    "7950be4d-13a3-48e7-906b-5af562e39544" to ("remixed" to "remixer"),
    // "produced material that was {additional:additionally} sampled in" to "contains {additional} samples by"
    "83f72956-2007-4bca-8a97-0ae539cca99d" to ("produced material that was sampled in" to "contains samples by"),
    ...
    // {additional}
    "fd33dadb-a588-40f4-8055-32373f1bd19b" to ("animation" to "animation"),
    // {additional}
    "dfbc387e-4659-4673-8d98-2fcf5ccebcdf" to ("artwork" to "artwork"),
    // {additional} {assistant}
    "d860c4da-16ea-419f-94c6-bc545a09143f" to ("design" to "design"),
    // {additional}
    "38751410-ee52-435b-af75-957cb4c34149" to ("graphic design" to "graphic design"),
    // {additional}
    "0c73d6e6-d741-4098-9d74-e8da0c63fe14" to ("illustration" to "illustration"),
    // {assistant}
    "e298d295-7f0f-40ac-8c50-dd7bcb00c164" to ("choreographer for" to "choreographer"),
    "4b290951-ab5e-4605-a304-650aa1f35377" to ("cinematographer for" to "cinematographer"),

    // production
    // {additional:additionally} {assistant} {associate} {co:co-}{executive:executive }
    "5c0ceac3-feb4-41f0-868d-dc06f6e27fc0" to ("produced" to "producer"),
    // {additional:additionally} {assistant} {associate} {co:co-}{executive:executive }
    "5dcc52af-7064-4051-8d62-7d80f4c3c907" to ("engineered" to "engineer"),
    // {additional:additionally} {assistant} {associate} {co:co-}
    "ca8d6d99-b847-439c-b0ec-33d8a1b942bc" to ("audio engineered" to "audio engineer"),
    // {additional} {assistant} {associate} {co:co-}
    "30adb2d7-dbcc-4393-9230-2098510ce3c1" to ("mastering" to "mastering"),
    // {additional:additionally} {assistant} {associate} {co:co-}
    "0cd6aa63-c297-42ed-8725-c16d31913a98" to ("sound engineered" to "sound engineer"),
    // {additional:additionally} {assistant} {associate} {co:co-}
    "3e3102e1-1896-4f50-b5b2-dd9824e46efe" to ("mixed" to "mixer"),
    // {additional} {assistant} {associate} {co:co-}
    "a01ee869-80a8-45ef-9447-c59e91aa7926" to ("recording engineer for" to "recording engineer"),
    "fc9b963a-29fa-4949-b22a-3bffd2440024" to ("field recordist for" to "field recordings"),
    // {additional} {assistant} {associate} {instrument}
    "36c50022-44e0-488d-994b-33f11d20301e" to ("programming" to "programming"),
    // {additional:additionally} {assistant} {associate} {co:co-}
    "40dff87a-e475-4aa6-b615-9935b564d756" to ("edited" to "editor"),
    // {additional:additionally} {assistant} {associate} {co:co-}
    "0748fa55-56b5-4ad5-8ce8-15b97f82a0c2" to ("balance engineered" to "balance engineer"),
    "53293ec0-e1b6-4d9b-998f-009e60bdd663" to ("sound effect for" to "sound effects"),
    ...
    "05df6850-a443-492f-a3ce-2f566e210def" to ("holds copyright (©) for video" to "video copyrighted (©) by"),
    ...
    // {additional}
    "0eb67a3e-796b-4394-ab6e-1224f43236b6" to ("creative direction" to "creative direction"),
    // {additional}
    "9aae9a3d-7cc2-4eee-881d-b8b73d0ceef3" to ("art direction" to "art direction"),
    // {additional}
    "4af8e696-2690-486f-87db-bc8ec2bfe859" to ("design/illustration" to "design/illustration"),
    // {additional}
    "38751410-ee52-435b-af75-957cb4c34149" to ("graphic design" to "graphic design"),
    // {additional}
    "a7e408a1-8c64-4122-9ec2-906068955187" to ("photography" to "photography"),
    ...
    "da514c41-ca48-4af2-81a4-c543f6c52dff" to ("dedicated recordings" to "dedicated to"),
    ...
    "db27e5d1-d935-45ad-ab02-a72bfd6c94ea" to ("holds copyright (©) for video" to "video copyrighted (©) by"),
    ...
    "4c5b6881-7f57-4687-9691-913767a1f9ae" to ("contracted editing for" to "edited for"),
    "e43d91b4-23d8-4a20-848f-1e1a392e23f0" to ("contracted mixing for" to "mixed for"),
    // {co:co-}{executive:executive }
    "ce1529b0-2fd9-4dcc-82d2-4036a044b5b9" to ("contracted production for" to "produced for"),
    "317009f8-9f7f-46e4-9d3e-5d69a56ed08f" to ("contracted remixing for" to "remixed for"),

    // production
    // {additonal:additionally }
    "d2992919-4cff-442a-9583-e516e518c6c8" to ("mixed" to "mixer"),
    // {additonal:additionally }
    "8cd0539d-3a86-4683-92e7-08ce105f6451" to ("recorded" to "recorded by"),

    "b908f91f-cf13-4ef7-9c84-b7f1122162c6" to ("broadcast" to "broadcast by"),
    ...
    // {additonal:additionally }
    "f845a95e-b2b5-4a94-9645-fc8b031ab0bd" to ("engineering location for" to "engineered at"),
    // {additonal:additionally }
    "ad462279-14b0-4180-9b58-571d0eef7c51" to ("recording location for" to "recorded at"),
    // {additonal:additionally }
    "11d74801-1493-4a5d-bc0f-4ddc537acddb" to ("mixing location for" to "mixed at"),
    // {additonal:additionally }
    "069c1cf0-a9b2-448e-8486-1eced48b48f9" to ("editing location for" to "edited at"),
    // {additonal:additionally }
    "88183045-b769-48ba-a55c-c58450903241" to ("remixing location for" to "remixed at"),
    // {additonal:additionally }
    "6bc3827d-bc20-4621-ae14-9c3707ad140a" to ("producing location for" to "produced at"),
    // {additonal:additionally }
    "07e6b4eb-5891-4646-b167-f96c5a4ccc77" to ("shooting location for" to "shot at"),
    ...
    // {additonal:additionally }
    "3a24272b-3273-456a-9be8-421580513d4b" to ("engineering location for" to "engineered in"),
    // {additonal:additionally }
    "354043e1-bdc2-4c7f-b338-2bf9c1d56e88" to ("recording location for" to "recorded in"),
    // {additonal:additionally }
    "653b7420-c418-4bdc-83a5-6b2f44a65915" to ("mixing location for" to "mixed in"),
    // {additional} {pre:pre-}{re}
    "ee380877-3636-462b-b407-ab39370a787e" to ("mastering location for" to "mastered in"),
    "2d9a192c-cd30-4110-a99e-481c56a0ce70" to ("lacquer cut location for" to "lacquer cut in"),
    // {additonal:additionally }
    "e42af9dd-4203-480c-9178-ee4f67ba2609" to ("editing location for" to "edited in"),
    // {additonal:additionally }
    "5147db55-6240-4479-bfa9-0589455f1c50" to ("remixing location for" to "remixed in"),
    // {additonal:additionally }
    "d5baaf36-5e8f-43f5-afaa-845965d28559" to ("transferring location for" to "transferred in"),
    // {additonal:additionally }
    "8d60be20-959c-4f5b-85f6-2b1f44321d11" to ("producing location for" to "produced in"),
    ...
    // {additonal:additionally }
    "6c799b93-556e-41b8-853d-3b8320786eaa" to ("writing location for" to "written in"),
    // {additonal:additionally }
    "4a1d7968-4e3f-4293-a746-5051dd2596d5" to ("composition location for" to "composed in"),
    // {additonal:additionally }
    "1df38ffb-375b-4b57-b9ec-5e103b57605d" to ("lyrics writing location for" to "lyrics written in"),
    // {additional:additionally }
    "6e35e603-af14-4360-8c36-b080429f89e1" to ("libretto writing location for" to "libretto written in"),
    "e2866d42-d86f-49ab-ba26-e05276d858f6" to ("revising location for" to "revised in"),
    // {additional:additionally }
    "dfc56643-84fa-450f-9dd6-9b8a3ea8a451" to ("translating location for" to "translated in"),
    // {additional:additionally }
    "d59c5121-7d6c-4965-9fa8-ab47b7d59012" to ("arranging location for" to "arranged in"),

    // TODO: handle more relationship types from here
