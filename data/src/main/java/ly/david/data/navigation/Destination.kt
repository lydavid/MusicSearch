...
enum class Destination(val route: String) {
    ...
    COLLECTIONS_INSTRUMENT("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_INSTRUMENT"),
    COLLECTIONS_LABEL("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_LABEL"),
    COLLECTIONS_PLACE("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_PLACE"),
    COLLECTIONS_RECORDING("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_RECORDING"),
    COLLECTIONS_RELEASE("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_RELEASE"),
    COLLECTIONS_RELEASE_GROUP("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_RELEASE_GROUP"),
    COLLECTIONS_SERIES("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_SERIES"),
    COLLECTIONS_WORK("$TOP_LEVEL_COLLECTIONS$DIVIDER$RESOURCE_WORK"),
