...
fun WikipediaSection(
    ...
    if (extract != null && extract.extract.isNotBlank() && extract.wikipediaUrl.isNotBlank()) {
        Column(
            modifier = modifier,
        ) {
            if (extract.extract.contains(filterText)) {
            ...
            if (extract.wikipediaUrl.contains(filterText)) {
