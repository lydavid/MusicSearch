...
const val DEFAULT_MINIMUM_INTERACTIVE_COMPONENT_SIZE = 48

const val TAG_BACKGROUND_ALPHA = 0.2f
const val PROGRESS_TRACK_ALPHA = 0.2f
const val SELECTED_ALPHA = 0.2f
const val HIGHLIGHTED_ALPHA = 0.3f
