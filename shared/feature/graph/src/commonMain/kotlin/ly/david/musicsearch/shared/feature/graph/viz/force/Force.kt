...
import ly.david.musicsearch.shared.feature.graph.viz.core.math.EPSILON
import kotlin.random.Random

public fun <D> forceSimulation(init: ForceSimulation<D>.() -> Unit): ForceSimulation<D> =
    ForceSimulation<D>().apply { init() }
