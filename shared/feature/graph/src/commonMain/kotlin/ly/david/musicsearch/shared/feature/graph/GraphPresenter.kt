...
internal class GraphPresenter(
    ...
    override fun present(): GraphUiState {
        ...
        val stitches: MutableList<Stitch> = (0 until totalStitches).map {
        ...
        var forceLinks: ForceLink<Stitch>? by remember { mutableStateOf(null) }
        val simulation: ForceSimulation<Stitch> by remember {
            mutableStateOf(
                forceSimulation {
        ...
        var links: List<LineNode> by remember {
            mutableStateOf(
                buildList {
        ...
        var winds: List<CircleNode> by remember {
            mutableStateOf(
                simulation.nodes.slice(totalStitches..totalStitches + 2).map {
                    CircleNode(
                        CircleGeom(
                            x = it.x,
                            y = it.y,
