...
sealed interface ListFilters {
    ...
    data class Instruments(
        override val query: String = "",
        override val isRemote: Boolean = true,
        val sortOption: InstrumentSortOption = InstrumentSortOption.InsertedAscending,
    ) : ListFilters

    data class Labels(
        override val query: String = "",
        override val isRemote: Boolean = true,
        val sortOption: LabelSortOption = LabelSortOption.InsertedAscending,
    ) : ListFilters

    data class Places(
        override val query: String = "",
        override val isRemote: Boolean = true,
        val sortOption: PlaceSortOption = PlaceSortOption.InsertedAscending,
    ) : ListFilters
