...
sealed interface ImageMetadata {
    ...
    data class InternetArchive(
        ...
        override val thumbnailImageUrl: String =
            rawThumbnailUrl.transformThisIfNotNullOrEmpty { it.prependHttpsIfMissing() }
        override val largeImageUrl: String =
            rawLargeUrl.transformThisIfNotNullOrEmpty { it.prependHttpsIfMissing() }
    ...
    data class Wikimedia(
        ...
        override val thumbnailImageUrl: String =
            rawThumbnailUrl.transformThisIfNotNullOrEmpty { "${WIKIMEDIA_IMAGE_BASE_URL}$it" }
        override val largeImageUrl: String =
            rawLargeUrl.transformThisIfNotNullOrEmpty { "${WIKIMEDIA_IMAGE_BASE_URL}$it" }
        override val linkUrl: String =
            rawLargeUrl.transformThisIfNotNullOrEmpty { "${WIKIMEDIA_LINK_BASE_URL}$it" }
    }
}
